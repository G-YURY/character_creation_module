...
def start_training(character):
    ...
    character_description = {'warrior': 'ты Воитель — великий мастер ближнего боя.',
                            'mage': 'ты Маг — превосходный укротитель стихий.',
                            'healer': 'ты Лекарь — чародей, способный исцелять раны.'}
    
    object_name = character.__class__.__name__.lower()
    print(f'{character.name}, {character_description[object_name]}')
